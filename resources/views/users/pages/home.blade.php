	...
	<div class="container">
		<div class="arriv-top">
			<div class="col-md-6 arriv-left">
				<img src="{{ asset('public/images/1.jpg') }}" class="img-responsive" alt="">
			...
			<div class="col-md-6 arriv-right">
				<img src="{{ asset('public/images/2.jpg') }}" class="img-responsive" alt="">
				<div class="arriv-info">
					<h3>TUXEDO</h3>
					<p>REVIVE YOUR WARDROBE WITH CHIC KNITS</p>
					<div class="crt-btn">
...
<div class="special">
	<div class="container">
		...
		<div class="specia-top">
			<ul class="grid_2">
		<li>
				<a href="details.html"><img src="{{ asset('public/images/8.jpg') }}" class="img-responsive" alt=""></a>
		...
		<li>
				<a href="details.html"><img src="{{ asset('public/images/9.jpg') }}" class="img-responsive" alt=""></a>
				<div class="special-info grid_1 simpleCart_shelfItem">
		...
		<li>
				<a href="details.html"><img src="{{ asset('public/images/10.jpg') }}" class="img-responsive" alt=""></a>
				<div class="special-info grid_1 simpleCart_shelfItem">
		...
		<li>
				<a href="details.html"><img src="{{ asset('public/images/11.jpg') }}" class="img-responsive" alt=""></a>
				<div class="special-info grid_1 simpleCart_shelfItem">
