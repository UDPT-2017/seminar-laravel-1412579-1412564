...
{  
   ...
   {
		$('#alert').html('Còn <span style="font-size: 20px; color: red;"">'  + delay + '</span> phút nữa sẽ hết thời gian làm bài. Hãy kiểm tra lại bài làm và ấn nộp bài để hoàn thiện bài thi'); 
		$('#alert').fadeIn(1000);
...
function timeDisplay_Conbtest(txtTimeDislay, days, hours, minute, second, delay, btSave) 
{  
    dayslimit = days;
    hourslimit = hours;
    minutelimit = minute;
